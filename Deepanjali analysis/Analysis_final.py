...
# Extracts all the needed features from all the files and stores it in a csv file. Uses allensdk package.
...
for filename in os.listdir('Deepanjali data/WT step input cells'):
    ...
    if filename in ['Cell 2 of 21_3_2017.abf']:
    ...
    features = singlefeature([10,16],reader,filename,stim_start,stim_end)
